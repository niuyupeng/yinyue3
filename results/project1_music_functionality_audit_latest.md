...
| 功能门槛 | 分值 | 状态 | 证据 |
|---|---:|---|---|
| `input_preflight_and_batch_generation` | 15/15 | PASS: pass | `generated_scores/batch_user_harmonize_authentic_cadence_smoke_v3/batch_harmonization_summary.json` |
| `satb_musicxml_export` | 15/15 | PASS: pass | `generated_scores/batch_user_harmonize_authentic_cadence_smoke_v3/batch_harmonization_summary.json` |
| `known_voice_preservation` | 10/10 | PASS: pass | `generated_scores/batch_user_harmonize_authentic_cadence_smoke_v3/batch_harmonization_summary.json` |
| `rule_reports_and_symbolic_repair` | 10/10 | PASS: pass | `generated_scores/batch_user_harmonize_authentic_cadence_smoke_v3/batch_harmonization_summary.json` |
