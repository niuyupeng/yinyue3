param(
    [string]$PackageDir = "",
    [string]$OutJson = "results/project1_delivery_conformance_audit_latest.json"
)
...
& $python -m chorale.delivery_conformance_audit --package-dir $PackageDir --out-json $OutJson
if ($LASTEXITCODE -ne 0) {
    throw "Project1 delivery conformance audit failed."
}
