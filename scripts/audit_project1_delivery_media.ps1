param(
    [string]$PackageDir = "",
    [string]$OutJson = "results/project1_delivery_media_audit_latest.json"
)
...
& $python -m chorale.delivery_media_audit --package-dir $PackageDir --out-json $OutJson
if ($LASTEXITCODE -ne 0) {
    throw "Project1 delivery media audit failed."
}
